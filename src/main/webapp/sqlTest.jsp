...
question.getId() %>">
 <input type="radio" name="answer<%= question.getId() %>"
value="1"> <%= question.getOption1() %><br>
 <input type="radio" name="answer<%= question.getId() %>"
value="2"> <%= question.getOption2() %><br>
 <input type="radio" name="answer<%= question.getId() %>"
value="3"> <%= question.getOption3() %><br>
 <input type="radio" name="answer<%= question.getId() %>"
value="4"> <%= question.getOption4() %><br>
 <hr>
 <% } } %>
