...
SQLQuestionDAO.getSQLQuestionById(questionId);
 // Forward the question object to the JSP page for editing
 request.setAttribute("question", sqlQuestion);
 
request.getRequestDispatcher("editsqlquestion.jsp").forward(request, 
response);
 }
...
sqlQuestion.setCorrectOption(Integer.parseInt(request.getParameter("correct Option")));
